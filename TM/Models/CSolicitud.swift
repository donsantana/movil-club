...
class CSolicitud {
  ...
  func DatosSolicitud(idSolicitud: String, fechaHora: String, dirOrigen: String, referenciaOrigen: String, dirDestino: String, latOrigen: Double, lngOrigen: Double, latDestino: Double, lngDestino: Double, valorOferta: String, detallesOferta: String, fechaReserva: String, tipoTransporte: String){
    self.idSolicitud = idSolicitud
    self.fechaHora = fechaHora
